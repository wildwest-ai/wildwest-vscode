        ...
        },
        {
          ...
          inputSchema: {
            ...
            properties: {
              ...
              targetScope: { type: 'string', enum: ['town', 'county', 'territory'], description: 'Target scope for draft: town (local/default), county (ancestor), or territory (SSOT)' },
            },
        ...
        },
        {
          ...
          inputSchema: {
            ...
            properties: {
              ...
              type: { type: 'string', description: 'Wire type (default: status-update)' },
              re: { type: 'string', description: 'Reference wire wwuid' },
              targetScope: { type: 'string', enum: ['town', 'county', 'territory'], description: 'Target scope for wire: town (local/default), county (ancestor), or territory (SSOT)' },
            },
            required: ['from', 'to', 'subject', 'body'],
          },
        },
